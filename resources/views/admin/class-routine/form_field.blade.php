<div class="card-block" id="inputFormField">
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control select2" name="teacher[]" id="teacher" required>
                ...
                @foreach ($teachers as $teacher)
                    <option value="{{ $teacher->id }}" @if (old('teacher') == $teacher->id) selected @endif>
        ...
        <div class="form-group col-md-2">
            <button id="removeField" type="button" class="btn btn-danger btn-filter"><i class="fas fa-trash-alt"></i>

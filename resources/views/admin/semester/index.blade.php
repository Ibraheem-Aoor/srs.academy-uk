                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="year" id="year" required>
                                            ...
                                            <option value="1" @if (old('year') == 1) selected @endif>
                                                {{ __('1st_year') }}</option>
                                            <option value="2" @if (old('year') == 2) selected @endif>
                                                {{ __('2nd_year') }}</option>
                                            <option value="3" @if (old('year') == 3) selected @endif>
                                                {{ __('3rd_year') }}</option>
                                            <option value="4" @if (old('year') == 4) selected @endif>
                                                {{ __('4th_year') }}</option>
                                            <option value="5" @if (old('year') == 5) selected @endif>
                                                {{ __('5th_year') }}</option>
                                            <option value="6" @if (old('year') == 6) selected @endif>
                                                {{ __('6th_year') }}</option>
                                            <option value="7" @if (old('year') == 7) selected @endif>
                                                {{ __('7th_year') }}</option>
                                            <option value="8" @if (old('year') == 8) selected @endif>
                                                {{ __('8th_year') }}</option>
                                        </select>

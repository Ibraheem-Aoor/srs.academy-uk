                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            @can($access . '-create')
                                <a href="{{ route($route . '.create', ['quick_course' => $is_quick_course]) }}"
                                    class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('btn_add_new') }}</a>
                            @endcan
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" name="subject_type" id="subject_type">
                                                ...
                                                <option value="1" @if ($selected_subject_type == 1) selected @endif>
                                                    {{ __('subject_type_compulsory') }}</option>
                                                <option value="2" @if ($selected_subject_type == 2) selected @endif>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" name="class_type" id="class_type">
                                                <option value="">{{ __('all') }}</option>
                                                <option value="1" @if ($selected_class_type == 1) selected @endif>
                                                    {{ __('class_type_theory') }}</option>
                                                <option value="2" @if ($selected_class_type == 2) selected @endif>
                                                    {{ __('class_type_practical') }}</option>
                                                <option value="3" @if ($selected_class_type == 3) selected @endif>

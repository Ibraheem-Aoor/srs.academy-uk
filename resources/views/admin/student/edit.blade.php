                                            ...
                                            <fieldset class="row scheduler-border">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="last_name"
                                                        id="last_name" value="{{ $row->last_name }}" required>
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="school_name"
                                                    id="school_name" value="{{ $row->school_name }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="school_exam_id"
                                                    id="school_exam_id" value="{{ $row->school_exam_id }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="school_graduation_year"
                                                    ...
                                                    value="{{ $row->school_graduation_year }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="school_graduation_point"
                                                    ...
                                                    value="{{ $row->school_graduation_point }}">
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="collage_name"
                                                    id="collage_name" value="{{ $row->collage_name }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="collage_exam_id"
                                                    id="collage_exam_id" value="{{ $row->collage_exam_id }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="collage_graduation_year"
                                                    ...
                                                    value="{{ $row->collage_graduation_year }}">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="{{ $row->collage_graduation_point }}">
                                                    ...
                                                    <div id="inputFormField" class="row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $relative->occupation }}" required>

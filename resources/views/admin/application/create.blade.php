                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="row scheduler-border">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label
                                                                for="permanent_address">{{ __('field_address') }}</label>
                                                            <input type="text" class="form-control"
                                        ...
                                        <content class="form-step">
                                            ...
                                            @if (field('application_school_info')->status == 1)
                                                <fieldset class="row scheduler-border">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="school_name">{{ __('field_school_name') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control" name="school_name"
                                                            id="school_name" value="{{ old('school_name') }}" required>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="school_exam_id">{{ __('field_exam_id') }}
                                                            <span>*</span></label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label
                                                            for="school_graduation_year">{{ __('field_graduation_year') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="school_graduation_year" id="school_graduation_year"
                                                            value="{{ old('school_graduation_year') }}" required>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label
                                                            for="school_graduation_point">{{ __('field_graduation_point') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="school_graduation_point" id="school_graduation_point"
                                                            value="{{ old('school_graduation_point') }}" required>

                                                        <div class="invalid-feedback">
                                                            {{ __('required_field') }}
                                                            {{ __('field_graduation_point') }}
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            @endif
                                            ...
                                            @if (field('application_collage_info')->status == 1)
                                                <fieldset class="row scheduler-border">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="collage_name">{{ __('field_collage_name') }}
                                                            <span>*</span></label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="collage_exam_id">{{ __('field_exam_id') }}
                                                            <span>*</span></label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label
                                                            for="collage_graduation_year">{{ __('field_graduation_year') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="collage_graduation_year" id="collage_graduation_year"
                                                            value="{{ old('collage_graduation_year') }}" required>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label
                                                            for="collage_graduation_point">{{ __('field_graduation_point') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="collage_graduation_point" id="collage_graduation_point"
                                                            value="{{ old('collage_graduation_point') }}" required>
                                    ...
                                    @if (field('application_photo')->status == 1 || field('application_signature')->status == 1)
                                        ...
                                        <content class="form-step">
                                            ...
                                            <fieldset class="row scheduler-border">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="grade_transcripts">{{ __('grade_transcripts') }}:
                                                        <span id="grade_transcripts_hint"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" name="grade_transcripts"
                                                        id="grade_transcripts" value="{{ old('grade_transcripts') }}"
                                                        required>

                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('grade_transcripts') }}
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="previous_certificates">{{ __('previous_certificates') }}:
                                                        <span id="previous_certificates_hint"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control"
                                                        name="previous_certificates" id="previous_certificates"
                                                        value="{{ old('previous_certificates') }}" required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('previous_certificates') }}
                                                    </div>
                                                </div>

                                                {{-- For DM ONLY --}}
                                                <div class="form-group col-md-6 d-none dm-only">
                                                    <label for="proof_master_in_en">{{ __('proof_master_in_en') }}:
                                                        <span id="proof_master_in_en"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" hidden
                                                        name="proof_master_in_en" id="proof_master_in_en"
                                                        value="{{ old('proof_master_in_en') }}" required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('proof_master_in_en') }}
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 d-none dm-only">
                                                    <label for="previous_certificates">{{ __('id_or_passport') }}:
                                                        <span id="id_or_passport"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" name="id_or_passport"
                                                        id="id_or_passport" hidden value="{{ old('id_or_passport') }}"
                                                        required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('id_or_passport') }}
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 d-none dm-only">
                                                    <label for="previous_certificates">{{ __('letter_of_intrest') }}:
                                                        <span id="letter_of_intrest"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" hidden
                                                        name="letter_of_intrest" id="letter_of_intrest"
                                                        value="{{ old('letter_of_intrest') }}" required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('letter_of_intrest') }}
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 d-none dm-only">
                                                    <label
                                                        for="certificate_of_recommendation">{{ __('certificate_of_recommendation') }}:
                                                        <span id="certificate_of_recommendation"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" hidden
                                                        name="certificate_of_recommendation"
                                                        id="certificate_of_recommendation"
                                                        value="{{ old('certificate_of_recommendation') }}" required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }}
                                                        {{ __('certificate_of_recommendation') }}
                                                    </div>
                                                </div>
                                                {{-- Bechalor Only --}}
                                                <div class="form-group col-md-6 d-none bechalor-only">
                                                    <label for="previous_certificates">{{ __('english_certificate') }}:
                                                        <span id="english_certificate"></span>
                                                        <span>*</span></label>
                                                    <input type="file" class="form-control" hidden
                                                        name="english_certificate" id="english_certificate"
                                                        value="{{ old('english_certificate') }}" required>
                                                    <div class="invalid-feedback">
                                                        {{ __('required_field') }} {{ __('english_certificate') }}
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        form.steps({
            ...
            onStepChanged: function(event, currentIndex, priorIndex) {
                var selected_program = $('#program option:selected');
                var program_category = selected_program.attr('data-category');

                // Hide all input elements and their containers by default
                $('.dm-only, .bechalor-only').addClass('d-none');
                $('.dm-only input, .bechalor-only input').attr('hidden', true).prop('disabled', true);


                // Handle the different categories
                if (program_category == 'Doctor') {
                    $('#grade_transcripts_hint').text('{{ __('hint_grade_transcripts_for_dm') }}');
                    $('.dm-only').removeClass('d-none');
                    $('.dm-only input').removeAttr('hidden').prop('disabled', false);
                } else if (program_category == 'Master') {
                    $('#grade_transcripts_hint').text('{{ __('hint_grade_transcripts_for_master') }}');
                    $('#previous_certificates_hint').text('{{ __('previous_certificates_for_master') }}');
                    // Add any additional logic for Master if needed
                } else if (program_category == 'Bachelor') {
                    $('#grade_transcripts_hint').text('{{ __('hint_grade_transcripts_for_bachelor') }}');
                    $('#previous_certificates_hint').text('{{ __('previous_certificates_for_bachelor') }}');
                    $('.bechalor-only').removeClass('d-none');
                    $('.bechalor-only input').removeAttr('hidden').prop('disabled', false);
                }
            },

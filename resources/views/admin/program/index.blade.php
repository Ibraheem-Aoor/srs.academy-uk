                                        ...
                                        <select class="form-control" name="faculty" id="faculty" required>
                                            ...
                                            @foreach ($faculties as $faculty)
                                                <option value="{{ $faculty->id }}"
                                                    @if (old('faculty') == $faculty->id) selected @endif>{{ $faculty->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                            ...
                                            @endif
                                                ...
                                                <td>
                                                    @can($access . '-edit')
                                                        ...
                                                        <a href="{{ route($route . '.download', $row->id) }}" target="_blank"
                                                            class="btn bt-icon btn-warning btn-sm"
                                                            title="{{ __('study_plan_download') }}">

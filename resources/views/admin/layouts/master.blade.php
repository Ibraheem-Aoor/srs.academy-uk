                                ...
                                <div class="dropdown-menu dropdown-menu-right notification">
                                    ...
                                    <ul class="noti-body">
                                        @forelse(Auth::guard('web')->user()->unreadNotifications as $key => $notification)
                                            @if ($key < 10)
                                                @php
                                                    $notification_link = route('admin.dashboard.index');
                                                    $notification_type = '';
                                                    if ($notification->data['type'] == 'content') {
                                                        $notification_link = route('admin.content.index');
                                                        $notification_type = trans_choice('module_content', 1);
                                                    } elseif ($notification->data['type'] == 'notice') {
                                                        $notification_link = route('admin.notice.index');
                                                        $notification_type = trans_choice('module_notice', 1);
                                                    } elseif ($notification->data['type'] == 'prove_fees_uploaded') {
                                                        $notification_type = trans_choice('module_fees_due', 1);
                                                ...
                                                <li class="notification">
                                                    <a class="media" href="{{ $notification_link }}">

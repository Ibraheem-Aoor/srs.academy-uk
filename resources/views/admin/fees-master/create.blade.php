                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="discount">{{ __('field_discount') }} <span>*</span></label>
                                                <select class="form-control" name="discount" id="discount" required>
                                                    <option value="">{{ __('select') }}</option>
                                                    @foreach ($discounts as $discount)
                                                        <option value="{{ $discount->id }}"
                                                            @if (old('discount') == $discount->id) selected @endif>
                            ...
                            <div class="invalid-feedback">
                              {{ __('required_field') }} {{ __('field_due_date') }}
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control autonumber" name="amount"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="radio d-inline">
                                                    ...
                                                    <label for="type_fixed"
                                                        class="cr">{{ __('amount_type_fixed') }}</label>
                                                </div>
                                                <div class="radio d-inline">
                                                    <input type="radio" name="type" id="type_per_credit"
                                                        value="2" @if (old('type') == 2) checked @endif>
